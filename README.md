...
**`v0.2.5` — chạy đủ trên một máy, chưa lên store.**
...
| [`docs/25-audit-v0.7.13.md`](docs/25-audit-v0.7.13.md) | **Audit v0.7.12→v0.7.13** — 4 món nợ đã trả; hook nằm trong repo ba tuần mà chưa từng chạy, và 15 lỗi analyzer/test hoá ra không có thật |
...
| [`docs/16-roadmap-hoc-tu-chorereward.md`](docs/16-roadmap-hoc-tu-chorereward.md) | **Lộ trình học từ ChoreReward** — 24 việc về thiết kế, UX/UI và tính năng, mỗi việc đối chiếu với code thật |
