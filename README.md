...
| [`docs/16-roadmap-hoc-tu-chorereward.md`](docs/16-roadmap-hoc-tu-chorereward.md) | **Lộ trình học từ ChoreReward** — 9 việc về thiết kế, UX/UI và tính năng, mỗi việc đối chiếu với code thật |
