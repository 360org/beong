...
class _ChildProfileFormState extends State<ChildProfileForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final morningTasks = kTaskPresets
        .where((p) => p.dayPart == 'morning')
        .toList();
    final afternoonTasks = kTaskPresets
        .where((p) => p.dayPart == 'afternoon')
        .toList();
    final eveningTasks = kTaskPresets
        .where((p) => p.dayPart == 'evening')
        .toList();
        ...
        children: [
              ...
              child: const Column(
                children: [
                  RadioListTile<bool>(
                    contentPadding: EdgeInsets.zero,
                    title: Text(
                      'Theo quy tắc chung của gia đình (50 / 40 / 10)',
                    ),
                    value: false,
                  ),
                  RadioListTile<bool>(
                ...
                child: Column(
                  children: [
                    _SmartJarSlider(
                      ...
                      locked: _lockSpend,
                      onToggleLock: () =>
                          setState(() => _lockSpend = !_lockSpend),
          ...
          if (widget.showPresets && widget.onPresetsChanged != null) ...[
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    ...
                    final isAll =
                        widget.selectedPresetKeys.length == allKeys.length;
            ...
            _buildSessionGroup(
              ...
              onToggleExpand: () =>
                  setState(() => _expandEvening = !_expandEvening),
            ),
            ...
            _buildSessionGroup(
              ...
              onToggleExpand: () =>
                  setState(() => _expandHabits = !_expandHabits),
            ),
          ],
        ],
      ),
